...
Use the [paper suggestion form](https://github.com/Social-Atoms/awesome-social-sim/issues/new?template=paper-suggestion.yml) to propose a paper without editing code, or the [correction form](https://github.com/Social-Atoms/awesome-social-sim/issues/new?template=correction.yml) to fix an existing entry. Include a source and a short explanation of the paper's relevance.
